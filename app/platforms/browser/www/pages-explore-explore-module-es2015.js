...
let ExplorePage = class ExplorePage {
    constructor(platform, loadingCtrl) {
    ...
    addCluster(data) {
        ...
        this.map.on(_ionic_native_google_maps__WEBPACK_IMPORTED_MODULE_2__["GoogleMapsEvent"].MAP_READY).subscribe((params) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
        ...
        markerCluster.on(_ionic_native_google_maps__WEBPACK_IMPORTED_MODULE_2__["GoogleMapsEvent"].MARKER_CLICK).subscribe((params) => {
            let marker = params[1];
            marker.hideInfoWindow();
            // marker.setTitle(marker.get("name"));
            // marker.setSnippet(marker.get("address"));
            this.hideMissionCard = false;
            console.log(marker);
