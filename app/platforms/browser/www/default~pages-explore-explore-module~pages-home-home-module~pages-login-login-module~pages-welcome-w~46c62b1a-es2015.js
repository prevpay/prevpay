...
class SvgIconRegistryService {
    ...
    loadSvg(url, name = url) {
        ...
        /** @type {?} */
        const o = (/** @type {?} */ (this.loader.getSvg(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((/**
         * @param {?} svg
         * @return {?}
         */
        svg => {
         ...
         * @return {?}
         */
        svg => this.iconsByUrl.set(name, svg))), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])((/**
         * @param {?} err
         * @return {?}
         */
        err => {
         ...
         * @return {?}
         */
        () => this.iconsLoadingByUrl.delete(name))), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["share"])())));
...
let CampooButtonComponent = class CampooButtonComponent {
    constructor() {
...
let CampooHeaderComponent = class CampooHeaderComponent {
    constructor() { }
    ngOnInit() { }
};
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let CampooTabsComponent = class CampooTabsComponent {
    constructor() { }
    ngOnInit() { }
};
...
//# sourceMappingURL=default~pages-explore-explore-module~pages-home-home-module~pages-login-login-module~pages-welcome-w~46c62b1a-es2015.js.map