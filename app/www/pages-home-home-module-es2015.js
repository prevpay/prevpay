...
let HomePage = class HomePage {
    constructor(modalController, appState, accountService) {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.appState.store.account) {
                this.account = yield this.appState.store.account;
                console.log(this.account);
            }
            else {
                this.accountService.getAccount('NzV1fU0kVAPBBPno8p3H')
                    .subscribe((acc) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
...
let InvestModal = class InvestModal {
    constructor(modalController, appState, accountService, router) {
        this.modalController = modalController;
        this.appState = appState;
        this.accountService = accountService;
        this.router = router;
...
let ReceiveModal = class ReceiveModal {
    constructor(modalController, appState, accountService, router) {
        this.modalController = modalController;
        this.appState = appState;
        this.accountService = accountService;
